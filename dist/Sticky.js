    ...
    _createClass(Sticky, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                { ref: 'outer', className: (0, _classnames2['default'])('sticky-outer-wrapper', this.props.className, _defineProperty({}, this.props.activeClass, this.state.status === STATUS_FIXED)), style: outerStyle },
...
Sticky.propTypes = {
    ...
    bottomBoundary: _react.PropTypes.oneOfType([_react.PropTypes.object, // TODO, may remove
